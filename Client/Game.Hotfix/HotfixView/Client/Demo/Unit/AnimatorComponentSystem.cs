...
// 		{
// 			AnimationComponent animator = self.GetParent<Unit>().GetComponent<EngineEntityComponent>().GameObject.Get<AnimationComponent>();
//
// 			if (animator == null)
// 			{
// 				return;
...
// 			
// 			foreach (var kv in animator.Animations)
// 			{
// 				self.animationClips[kv.Key] = kv.Value;
// 			}
